    ...
    <div className="flex flex-col items-center px-4 text-white">
      <div className='w-full mt-8 mb-16 overflow-auto'>
        <div className="w-full flex items-center justify-between p-3 mb-4 bg-gray-500 bg-opacity-25 rounded-xl">
          ...
          <button className="px-3 py-2 bg-gray-700 bg-opacity-50 hover:bg-dark text-white rounded-full"> 
            <h5>Open</h5>
          </button>
        </div>
        ...
        <h2 className="w-full text-center text-3xl mt-4">forsuccess425</h2>

        <h3 className="w-full text-center text-4xl mt-12">₿ 267</h3>

        <div className='w-full flex flex-col items-center mt-20 mb-4 bg-center bg-cover '>
          <img className="w-full max-h-36 bg-gray-800 rounded-xl" src={backgroundImg} />
          <div className="w-full flex flex-col items-center -mt-32 px-6">
            <img className="w-16" src={gameImg} alt="logo" />
            <div className="w-full flex items-center justify-between">
              <div>
                <h4>Drop game</h4>
                <p className="flex font-bold">
                  <img className="w-5 h-5 mr-2 mt-0.5" src={gameAvatar} />
                  5
                </p>
              </div>
